...
if __name__ == "__main__":
    ...
    DELAY.grid(row=6, column=4, ipadx=50)

    L2 = Label(gui, text="Enter the key value to be pressed")
    L2.grid(row=7, column=3, ipadx=50)
    KEY_VALUE = Entry(gui, bd=5)
    KEY_VALUE.grid(row=7, column=4, ipadx=50)

    L3 = Label(gui, text="Enter number of times the key to be fired")
    L3.grid(row=8, column=3, ipadx=50)
    NUM = Entry(gui, bd=5)
    NUM.grid(row=8, column=4, ipadx=50)
